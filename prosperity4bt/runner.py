...
def prepare_state(state: TradingState, data: BacktestData) -> None:
    ...
    # P4: no conversion observations in Round 0
...
def enforce_limits(
    ...
    for product in data.products:
        ...
        if limit is None:
            # No limit configured for this product — skip enforcement.
            # Add the product to LIMITS in data.py to enable enforcement.
            continue
...
def run_backtest(
    ...
    # Expose round/day to trader code via environment variables.
